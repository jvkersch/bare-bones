...
class BareBonesPreferences(PreferencesHelper):
    """ The preferences helper for the BareBones application.
    """

    #### 'PreferencesHelper' interface ########################################

    # The path to the preference node that contains the preferences.
    preferences_path = 'example.bare_bones'
...
class BareBonesPreferencesPane(PreferencesPane):
    """ The preferences pane for the BareBones application.
    """

    #### 'PreferencesPane' interface ##########################################

    # The factory to use for creating the preferences model object.
    model_factory = BareBonesPreferences
