...
# Local imports.
from bare_bones_preferences import BareBonesPreferences


class BareBonesApplication(TasksApplication):
    ...
    preferences_helper = Instance(BareBonesPreferences)
    ...
    def _preferences_helper_default(self):
        return BareBonesPreferences(preferences=self.preferences)
